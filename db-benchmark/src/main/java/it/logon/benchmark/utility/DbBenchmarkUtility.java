...
public class DbBenchmarkUtility {
    ...
    private static final String PRINTFORMAT = "| %15s | %16d | %16d |%n";
    ...
    public static void printBenchmarkResults(String statement, long totalExecutionTime, long minExecutionTime,
        ...
        System.out.printf(PRINTFORMAT, "Total Time", totalExecutionTime,
                TimeUnit.MILLISECONDS.toNanos(totalExecutionTime));
        System.out.printf(PRINTFORMAT, "Min Time", TimeUnit.NANOSECONDS.toMillis(minExecutionTime), minExecutionTime);
        System.out.printf(PRINTFORMAT, "Max Time", TimeUnit.NANOSECONDS.toMillis(maxExecutionTime), maxExecutionTime);
        System.out.printf("| %15s | %16f | %16f |%n", "Average Time", avgExecutionTime, avgExecutionTime * 1_000_000);
    }
